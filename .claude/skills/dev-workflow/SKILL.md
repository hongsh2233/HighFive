---
name: dev-workflow
description: High5 저장소에서 기능 추가/수정 등 신규 작업 요청을 처리할 때 항상 따라야 하는 작업 절차. 작업 시작 전 docs/PROJECT_STRUCTURE.md 확인, 완료 후 docs/HISTORY.md 기록과 PROJECT_STRUCTURE.md 갱신, 빌드/타입체크 검증, main 브랜치 머지 및 푸시까지 포함. "새 기능 추가해줘", "수정해줘", "구현해줘" 류의 코드 변경 요청에는 반드시 이 skill을 사용한다.
---
